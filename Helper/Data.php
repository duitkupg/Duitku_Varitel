...
use Duitku\Varitel\Helper\Duitku\Duitku_Varitel_Core;
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->getConfigData($field, 'duitku_variepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Varitel_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Varitel")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Varitel\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
