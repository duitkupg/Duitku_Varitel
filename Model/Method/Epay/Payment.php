...
class Payment extends \Duitku\Varitel\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_variepay';
    const METHOD_REFERENCE = 'duitkuvariReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Varitel\Block\Info\View';
    ...
    /**
     * @var \Duitku\Varitel\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Varitel\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Varitel\Model\Api\Epay\Request\Payment
     */
    ...
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epayvari/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epayvari/accept');
     ...
     * @return \Duitku\Varitel\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvari/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvari/cancel', ['_secure' => $this->_request->isSecure()]);
    }
